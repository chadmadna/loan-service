...
func (_m *ProductUsecase) FetchProductByID(ctx context.Context, productID uint) (*models.Product, error) {
...
func (_m *ProductUsecase) FetchProducts(ctx context.Context) ([]models.Product, error) {
	ret := _m.Called(ctx)
